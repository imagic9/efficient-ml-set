...
def main() -> int:
    ...
    lines += [
        ...
        "0.5 threshold (DESIGN §7.2; the AP alternative was tried and reverted by its",
        "pre-registered test — see the §7.2 verdict, issue #19). C3 calibrates the real",
        "operating point; this is a constant yardstick for comparing candidates, not an",
        "operating point.",
        "",
